...
var script__$1 = (function (){var G__5405 = script;
(G__5405["type"] = "text/javascript");

(G__5405["onload"] = onload);

(G__5405["onreadystatechange"] = onload);

return G__5405;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__5406 = script__$1;
(G__5406["src"] = src);

return G__5406;
})():(function (){var G__5407 = script__$1;
goog.dom.setTextContext(G__5407,opt_sourceText);
...
var path_5408 = (goog.dependencies_.nameToPath[src]);
delete goog.dependencies_.visited[path_5408];

delete goog.dependencies_.written[[cljs.core.str(goog.basePath),cljs.core.str(path_5408)].join('')];
} else {
}
