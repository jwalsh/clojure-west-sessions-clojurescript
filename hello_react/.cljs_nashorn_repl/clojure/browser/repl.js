...
return (function (){
if(cljs.core.truth_((function (){var and__3302__auto__ = clojure.browser.repl.load_queue;
...
var script__$1 = (function (){var G__184 = script;
(G__184["type"] = "text/javascript");

(G__184["onload"] = onload);

(G__184["onreadystatechange"] = onload);

return G__184;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__185 = script__$1;
(G__185["src"] = src);

return G__185;
})():(function (){var G__186 = script__$1;
goog.dom.setTextContext(G__186,opt_sourceText);
...
var reload_QMARK_ = (function (){var or__3310__auto__ = reload;
...
var path_187 = (goog.dependencies_.nameToPath[src]);
delete goog.dependencies_.visited[path_187];

delete goog.dependencies_.written[[cljs.core.str(goog.basePath),cljs.core.str(path_187)].join('')];
} else {
}
