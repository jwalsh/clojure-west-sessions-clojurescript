...
var script__$1 = (function (){var G__95 = script;
(G__95["type"] = "text/javascript");

(G__95["onload"] = onload);

(G__95["onreadystatechange"] = onload);

return G__95;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__96 = script__$1;
(G__96["src"] = src);

return G__96;
})():(function (){var G__97 = script__$1;
goog.dom.setTextContext(G__97,opt_sourceText);
...
var path_98 = (goog.dependencies_.nameToPath[src]);
delete goog.dependencies_.visited[path_98];

delete goog.dependencies_.written[[cljs.core.str(goog.basePath),cljs.core.str(path_98)].join('')];
} else {
}
